...
var vertices = [
  ...
  vec4(0, 0, 0, 1), // I(8)
  vec4(0.5, 0, 0, 1), // J(9)
  vec4(0.5, 0.75, 0, 1), // K(10)
  vec4(0.25, 1, 0, 1), // L(11)
  vec4(0, 0.75, 0, 1), // M(12)
  vec4(0, 0, 5, 1), // N(13)
  vec4(0.5, 0, 5, 1), // O(14)
  vec4(0.5, 0.75, 5, 1), // P(15)
  vec4(0.25, 1, 5, 1), // Q(16)
  vec4(0, 0.75, 5, 1) // R(17)
...
function DrawSolidSphere(radius) {
  ...
  for (var i = 0; i < sphereCount; i += 3) gl.drawArrays(gl.TRIANGLES, i, 3);
  spherePointsEnd = i;
  modelViewMatrix = modelViewStack.pop(); //POP
}
...
function DrawNose() {
  ...
  modelViewMatrix = mult(
    mult(modelViewMatrix, translate(1, 2.45, 0.9)),
    rotate(-90, 1, 0, 0)
  ); //flip nose and put on head
  gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix));
  gl.drawArrays(
    gl.TRIANGLES,
    spherePointsEnd + boxPointEnd + postPointEnd,
    nosePointEnd
  );
  modelViewMatrix = modelViewStack.pop(); //POP
}
